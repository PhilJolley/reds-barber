@php
  ...
  $bkg_color = get_field('bkg_color', 'options');
  $border_bottom = get_field('border_bottom', 'options');
@endphp

<header id="site-header" style="background-color:{{$bkg_color}}; border-bottom: 2px solid {{$border_bottom}};">
